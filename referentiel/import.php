<?php  // $Id: import.php,v 1.1 2010/12/17 21:49:35 vf Exp $
///////////////////////////////////////////////////////////////////////////
//                                                                       //
// NOTICE OF COPYRIGHT                                                   //
//                                                                       //
...
*/
	...
	$currentgroup = setup_and_print_groups($course, $groupmode, 'import.php?d='.$referentiel->id);
...
//		update_module_button($cm->id, $course->id, get_string('modulename', 'referentiel')), // HTML code for a button (usually for module editing)
	...
	if ($mode=='listreferentiel'){
		referentiel_print_referentiel_instance($referentiel->id); 
	}
