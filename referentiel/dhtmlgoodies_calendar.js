...
function SetLanguageCode(language){
	...
	case "pt-br":  // Brazilian portuguese (pt-br) 
		...
		break;
	case "fr":      // French - Remember to use UTF-8 encoding, i.e. the <meta> tag 
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput, language)
{
...
function displayCalendarSelectBox(yearInput,monthInput,dayInput,hourInput,minuteInput,buttonObj, language)
{
	if (language){ 
		SetLanguageCode(language);
		// alert("language "+language );
