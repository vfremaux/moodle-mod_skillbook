...
*/
  ...
  $meta .= '<script type="text/javascript" src="functions.js"></script>'."\n";
    ...
    /*
    	...
    	groups_print_activity_menu($cm, $CFG->wwwroot . '/mod/referentiel/edit.php?d='.$referentiel->id.'&amp;mode='.$mode.'&amp;select_acc='.$select_acc);
	  */	
	}
	else{
		// 1.8
    ...
    $currentgroup = setup_and_print_groups($course, $groupmode, $CFG->wwwroot . '/mod/referentiel/edit.php?d='.$referentiel->id.'&amp;mode='.$mode.'&amp;select_acc='.$select_acc);
    */				
